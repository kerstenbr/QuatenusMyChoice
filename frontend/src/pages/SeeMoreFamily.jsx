...
const SeeMoreFamily = () => {
  ...
  const hasTelemetry = family.products
    ? Object.keys(family.products).some(
        (productName) => family.products[productName].telemetry
      )
    : false;
  ...
  return (
    <div className="py-2 bg-light">
      <div className="container">
        <button
          className="btn btn-sm btn-qorange mb-2 float-end"
          onClick={goBack}>
          Voltar
        </button>
        {user && user.admin === true ? (
          <>
            <Link to={`/family/edit/${family._id}`}>
              <button
                type="button"
                className="btn btn-sm btn-warning me-1 text-white float-end">
                Editar
              </button>
            </Link>
          </>
                          ...
                          return (
                            <tr key={productName}>
                              ...
                              <td className="text-center">
                                {product.telemetry.digital}
                              </td>
                              <td className="text-center">
                                {product.telemetry.analog}
                              </td>
                            </tr>
                          );
                        }
                  ...
                  Object.keys(family.products).map((productName) => {
                    ...
                    return (
                      <tr key={productName}>
                        ...
                        <td className="text-center">
                          R$ {product.preco.comAdesao[0]}
                        </td>
                        <td className="text-center">
                          R$ {product.preco.comAdesao[1]}
                        </td>
                        <td className="text-center">
                          R$ {product.preco.comAdesao[2]}
                        </td>
                        <td className="text-center">
                          R$ {product.preco.comAdesao[3]}
                        </td>
                        <td className="text-center">
                          R$ {product.preco.semAdesao[0]}
                        </td>
                        <td className="text-center">
                          R$ {product.preco.semAdesao[1]}
                        </td>
                        <td className="text-center">
                          R$ {product.preco.semAdesao[2]}
                        </td>
                        <td className="text-center">
                          R$ {product.preco.semAdesao[3]}
                        </td>
                        <td className="text-center">
                          R$ {product.preco.semAdesao[4]}
                        </td>
                        <td className="text-center">
                          R$ {product.preco.fecho}
                        </td>
                      </tr>
                    );
                  })
        ...
        <div>
          {family.addInfoLink ? (
            <>
              ...
              <img
                style={{ width: "100%" }}
                src={family.addInfoLink}
                alt="Informação adicional da família"
              />
            </>
          ) : null}
        </div>

                          ...
                          {product.price.renovation ? (
                            <>
                              {product.price.renovation[0] ? (
                                <td className="text-center text-truncate">R$ {product.price.renovation[0]}</td>
                              ) : (
                                <td className="text-center">N/A</td>
                              )}
                              {product.price.renovation[1] ? (
                                <td className="text-center text-truncate">R$ {product.price.renovation[1]}</td>
                              ) : (
                                <td className="text-center">N/A</td>
                              )}
                              {product.price.renovation[2] ? (
                                <td className="text-center text-truncate">R$ {product.price.renovation[2]}</td>
                              ) : (
                                <td className="text-center">N/A</td>
                              )}
                              {product.price.renovation[3] ? (
                                <td className="text-center text-truncate">R$ {product.price.renovation[3]}</td>
                              ) : (
                                <td className="text-center">N/A</td>
                              )}
                              {product.price.renovation[4] ? (
                                <td className="text-center text-truncate">R$ {product.price.renovation[4]}</td>
                              ) : (
                                <td className="text-center">N/A</td>
                              )}
                              {product.price.renovationClosure ? (
                                <td className="text-center text-truncate">R$ {product.price.renovationClosure}</td>
                              ) : (
                                <td className="text-center">N/A</td>
                              )}
                            </>
